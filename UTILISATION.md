...
**1. LibreOffice** — c'est le moteur qui fait la conversion.
Téléchargez-le sur **[libreoffice.org/download](https://www.libreoffice.org/download/)**, installez-le, c'est tout. Vous n'aurez jamais à l'ouvrir : colibri-converter s'en sert en arrière-plan.

**2. colibri-converter** — téléchargez l'archive dans la section *Releases* du dépôt, faites un clic droit dessus puis **Extraire tout**.
...
**Word → PDF : quasi parfait.** C'est le même moteur que celui de LibreOffice, le rendu est fidèle à l'original.
...
**« LibreOffice est requis » s'affiche en haut de la fenêtre**
LibreOffice n'est pas installé, ou l'installation est incomplète. Cliquez sur *Ouvrir la page de téléchargement*, installez-le, puis cliquez sur **Revérifier**. Pas besoin de fermer colibri-converter.

**Rien ne se passe quand je glisse mon fichier**
Le format n'est pas reconnu. Seuls `.docx`, `.doc`, `.odt`, `.rtf` et `.pdf` sont acceptés — un `.pages` ou un `.txt` sera ignoré.
