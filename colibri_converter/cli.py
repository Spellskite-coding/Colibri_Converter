...
from .engine import ConversionError, convert, safe_output_path
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--pdfa", action="store_true", help="Produire du PDF/A-2b (archivage)")
